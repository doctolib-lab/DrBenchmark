...
1. CAS, ESSAI and CLISTER are downloaded automatically from `https://drbenchmark.univ-avignon.fr/` by their `data_loaders_hf/fr/*.py` loading scripts — no manual file placement needed.
