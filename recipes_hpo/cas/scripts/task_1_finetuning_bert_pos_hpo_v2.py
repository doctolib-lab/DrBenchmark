...
def main():
    ...
    search_pattern = f"../runs/DrBenchmark-CAS-pos-{args.subset}-*_hpo.json"
    do_hpo = True
    best_hp_trial = None
    ...
    # label_list = dataset.features["pos_tags"].feature.names
    ...
    #  We need to remove duplicates across all splits
    seen = set()
    ...
    output_name = f"DrBenchmark-CAS-pos-{str(args.subset)}-{uuid.uuid4().hex}"
